...
ckptpath = sys.argv[1]
basename = os.path.splitext(os.path.basename(ckptpath))[0]
...
if num_speakers > 1:
    ...
    pnnx.export(model_g, basename + '_emb_g.torchscript', (sid,))
    ...
    pnnx.export(model_g, basename + '_enc_p.torchscript', (sequences,), (sequences2,), moduleop='piper.train.vits.attentions.relative_embeddings_k_module,piper.train.vits.attentions.relative_embeddings_v_module')
    ...
    pnnx.export(model_g, basename + '_dp.torchscript', (x, noise, g), (x2, noise2, g), moduleop='piper.train.vits.modules.piecewise_rational_quadratic_transform_module')
    ...
    pnnx.export(model_g, basename + '_flow.torchscript', (z_p, g))
    ...
    pnnx.export(model_g, basename + '_dec.torchscript', (z, g))
    ...
    model_g.forward = infer_forward_dp
    pnnx.export(model_g, basename + '_dp.torchscript', (x, noise), (x2, noise2), moduleop='piper.train.vits.modules.piecewise_rational_quadratic_transform_module')
    ...
    model_g.forward = infer_forward_flow
    pnnx.export(model_g, basename + '_flow.torchscript', (z_p, ))
    ...
    model_g.forward = infer_forward_dec
    pnnx.export(model_g, basename + '_dec.torchscript', (z, ))
